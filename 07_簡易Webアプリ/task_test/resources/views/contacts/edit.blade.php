                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1"
                                                        @if ($contact->age === 1) selected @endif>~19歳</option>
                                                    <option value="2"
                                                        @if ($contact->age === 2) selected @endif>20歳~29歳
                                                    </option>
                                                    <option value="3"
                                                        @if ($contact->age === 3) selected @endif>30歳~39歳
                                                    </option>
                                                    <option value="4"
                                                        @if ($contact->age === 4) selected @endif>40歳~49歳
                                                    </option>
                                                    <option value="5"
                                                        @if ($contact->age === 5) selected @endif>50歳~59歳
                                                    </option>
                                                    <option value="6"
                                                        @if ($contact->age === 6) selected @endif>60歳~</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
